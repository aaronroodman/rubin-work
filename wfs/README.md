...
- **wfs_giant_donut_fit**: Reads `raw` from `LSSTCam/raw/all` and runs ISR in-notebook
  ...
  (free, it ran to ~2.8″ here, over-blurring the model to absorb pupil mismatch).
