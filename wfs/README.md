...
- **wfs_batoid_pupil_compare**: Pure `batoid` for the trace; imports `lsst.obs.lsst` +
  ...
  to batoid camera-only. Needs `danish` + `lsst.ts.wep` (`getTaskInstrument`, `DefocalType`).
