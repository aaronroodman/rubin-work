...
|----------|-------------|---------|---------------|
| `guider_iq.ipynb` | Per-image science FWHM (from ConsDB `psf_sigma_median`) vs. guider metrics: `guider_total_seeing` and the quadrature sum of detrended altitude/azimuth pointing RMS. Applies simple guider quality cuts (`n_tracked_stars >= MIN_TRACKED_STARS`). | 2026-07-13 | 2026-07-13 |
