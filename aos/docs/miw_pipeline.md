...
Moved out of `../README.md` in the Phase 4 reorganization so the README can be an
index; the content is unchanged.

For which *study* each step belongs to, see [`studies.md`](studies.md). Launch with
`./run_snake.sh` from `aos/` — see [Running](#running).
